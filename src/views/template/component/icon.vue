<template>
  <div>
    ...
    <el-card header="本地图标" shadow="never" class="border-none! mt-4">
      <div class="flex items-center">
        <icon class="m-4" :size="24" name="local-icon-apps" />
        <icon class="m-4" :size="24" name="local-icon-associate" />
        <icon class="m-4" :size="24" name="local-icon-bianji" />
        <icon class="m-4" :size="24" name="local-icon-bukejian" />
        <icon class="m-4" :size="24" name="local-icon-chexiao" />
      </div>
    </el-card>
    ...
    <el-card header="本地图标库大全（点击复制图标名称）" shadow="never" class="border-none! mt-4">
      <div class="flex items-center">
        <div class="flex flex-wrap">
